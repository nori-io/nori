...
//2) plugin1 -> plugin2 -> plugin3 (3rd is absent)
...
//3) plugin1 -> plugin2 -> plugin3 (2nd is absent)
...
//5) plugin1-> interface (interface is absent)
...
//7)
//как номер 6, только номер 2 нет
//*/
